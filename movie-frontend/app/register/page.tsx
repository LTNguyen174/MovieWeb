    ...
    <div className="min-h-screen flex">
      ...
      <div className="hidden lg:block lg:flex-1 relative">
        <div
          ...
          style={{ backgroundImage: `url('/movie-popcorn-cinema-dark-aesthetic.jpg')` }}
        >
        ...
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="w-full max-w-md">
          ...
          <div className="relative my-8">
            ...
            <div className="relative flex justify-center">
              <span className="bg-background px-4 text-sm text-muted-foreground">or sign up with</span>
            </div>
          </div>

          {/* Social Buttons */}
          <Button variant="outline" className="w-full h-12 rounded-xl bg-transparent" onClick={googleLogin}>
